...
exports.getFullText = exports.getServicesByBoth = exports.getServicesByTags = exports.getServicesByCategory = exports.removeService = exports.updateService = exports.createService = exports.getAllServices = undefined;
...
var getFullText = function getFullText(req, res, next) {
  _dbConnection.db.any('SELECT * FROM service WHERE tsv @@ plainto_tsquery(\'english\', $1)', req.params.search).then(function (data) {
    res.status(200).json(data);
  }).catch(function (err) {
    return next(err);
  });
